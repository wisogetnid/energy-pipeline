...
from pipeline.data_retrieval.batch_retrieval import (
    BatchRetriever,
...
class TestBatchRetriever:
    ...
    def test_calculate_batch_date_ranges(self, retriever):
        ...
        date_ranges = retriever._calculate_batch_date_ranges(
    ...
    def test_get_readings_in_batches(
        self, retriever, mock_client, mock_readings_response
    ):
        ...
        readings = retriever.get_readings_in_batches(
            resource_id, start_date, end_date, batch_days=batch_size
        )
    ...
    def test_get_readings_handles_string_dates(self, retriever, mock_client):
        ...
        retriever.get_readings_in_batches(
            resource_id, start_date_str, end_date_str, batch_days=2
        )
